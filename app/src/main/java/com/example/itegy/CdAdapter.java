...
public class CdAdapter extends RecyclerView.Adapter<CdAdapter.CdViewHolder> {
    private LayoutInflater layoutInflater;
    ArrayList<Products> data;

    public CdAdapter(CdActivity cdActivity, ArrayList<Products> data) {
    ...
    public CdViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view=layoutInflater.from(parent.getContext()).inflate(R.layout.custom_product_view,null,
                false);
        CdViewHolder viewHolder=new CdViewHolder(view);
