...
public class LaptopsAdapter extends RecyclerView.Adapter<LaptopsAdapter.ViewHolder> {
    private LayoutInflater layoutInflater;
    ArrayList<Products> data;

    public LaptopsAdapter(LabtopActivity laptopActivity, ArrayList<Products> data) {
